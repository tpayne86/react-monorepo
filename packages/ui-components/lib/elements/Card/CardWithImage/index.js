...
const _card = _interopRequireDefault(require('antd/lib/card'));
...
const Meta = _card.default.Meta;

const CardWithImage = function CardWithImage(_ref) {
  const imgUrl = _ref.imgUrl;

  const title = _ref.title;

  const description = _ref.description;

  const imgAlt = _ref.imgAlt;
...
CardWithImage.propTypes = {
  ...
  identifier: _propTypes.default.oneOfType([
...
(function() {
  ...
  reactHotLoader.register(
    Meta,
    'Meta',
    '/Users/hannadrehman/workspace/open source/projects/react-monorepo/packages/ui-components/src/elements/Card/CardWithImage/index.jsx',
  );
  reactHotLoader.register(
    CardWithImage,
    'CardWithImage',
