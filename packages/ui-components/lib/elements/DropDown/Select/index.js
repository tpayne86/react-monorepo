...
const _select = _interopRequireDefault(require('antd/lib/select'));
    ...
    function AppSelect() {
      ...
      (0, _defineProperty2.default)(
        ...
        function(value, option) {
          const onValueSelect = _this.props.onValueSelect;
...
(function() {
  ...
  reactHotLoader.register(
    Option,
    'Option',
    '/Users/hannadrehman/workspace/open source/projects/react-monorepo/packages/ui-components/src/elements/DropDown/Select/index.jsx',
  );
  reactHotLoader.register(
    AppSelect,
    'AppSelect',
