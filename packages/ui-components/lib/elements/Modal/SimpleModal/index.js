...
const _modal = _interopRequireDefault(require('antd/lib/modal'));
...
const SimpleModal = function SimpleModal(_ref) {
  const children = _ref.children;

  const visible = _ref.visible;

  const onOk = _ref.onOk;

  const onCancel = _ref.onCancel;
...
(function() {
  ...
  reactHotLoader.register(
    SimpleModal,
    'SimpleModal',
    '/Users/hannadrehman/workspace/open source/projects/react-monorepo/packages/ui-components/src/elements/Modal/SimpleModal/index.jsx',
  );
  reactHotLoader.register(
    _default,
    'default',
