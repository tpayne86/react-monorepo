...
const _list = _interopRequireDefault(require('antd/lib/list'));
...
const renderAction = function renderAction(label, _onClick, id) {
...
const renderListItems = function renderListItems(item, actionLabel, onClick) {
  return _react.default.createElement(
    _list.default.Item,
    {
...
const SimpleListWithAction = function SimpleListWithAction(_ref) {
  const className = _ref.className;

  const dataSource = _ref.dataSource;

  const actionLabel = _ref.actionLabel;
...
SimpleListWithAction.propTypes = {
  ...
  dataSource: _propTypes.default.arrayOf(
...
const _default = SimpleListWithAction;
...
(function() {
  ...
  reactHotLoader.register(
    renderAction,
    'renderAction',
    '/Users/hannadrehman/workspace/open source/projects/react-monorepo/packages/ui-components/src/elements/List/SimpleListWithAction/index.jsx',
  );
  reactHotLoader.register(
    renderListItems,
    'renderListItems',
