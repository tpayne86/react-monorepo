  ...
  (function(_React$Component) {
    ...
    function ErrorHandler(props) {
      ...
      _this = (0, _possibleConstructorReturn2.default)(
        this,
        (0, _getPrototypeOf2.default)(ErrorHandler).call(this, props),
      );
      _this.state = {
        hasError: false,
        info: '',
    ...
    (0, _createClass2.default)(ErrorHandler, [
      ...
      },
      {
        ...
        value: function render() {
          ...
          const hasError = _this$state.hasError;

          const info = _this$state.info;

          const error = _this$state.error;
          ...
          if (hasError) {
            ...
            return _react.default.createElement(
              _style.Wrapper,
              null,
              _react.default.createElement(_style.Image, {
                alt: 'err',
                src:
                  'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f0/Error.svg/497px-Error.svg.png',
              }),
              _react.default.createElement('h1', null, 'Some Error Occured'),
              origin === _constants.DEV_ORIGIN &&
                _react.default.createElement(
                  ...
                  _react.default.createElement(
                    _style.ErrorTrace,
                    null,
                    _react.default.createElement('p', null, 'Exception Trace'),
                    _react.default.createElement('pre', null, error.stack),
                  ),
...
(function() {
  ...
  reactHotLoader.register(
    ErrorHandler,
    'ErrorHandler',
    '/Users/hannadrehman/workspace/open source/projects/react-monorepo/packages/ui-components/src/compounds/ErrorHandler/index.jsx',
  );
  reactHotLoader.register(
    _default,
    'default',
