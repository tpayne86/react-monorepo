...
const AuthorizeOnly = function AuthorizeOnly(_ref) {
  const children = _ref.children;

  const allowedRoles = _ref.allowedRoles;
...
(function() {
  ...
  reactHotLoader.register(
    AuthorizeOnly,
    'AuthorizeOnly',
    '/Users/hannadrehman/workspace/open source/projects/react-monorepo/packages/ui-components/src/compounds/AuthorizedOnly/index.jsx',
  );
  reactHotLoader.register(
    _default,
    'default',
