...
const _Alert = _interopRequireDefault(require('../../elements/Alert'));
...
const AlertFallback = function AlertFallback(_ref) {
  const hasAlert = _ref.hasAlert;

  const children = _ref.children;

  const type = _ref.type;

  const alertTitle = _ref.alertTitle;

  const alertDescription = _ref.alertDescription;

  const closable = _ref.closable;
...
(function() {
  ...
  reactHotLoader.register(
    AlertFallback,
    'AlertFallback',
    '/Users/hannadrehman/workspace/open source/projects/react-monorepo/packages/ui-components/src/compounds/AlertFallback/index.jsx',
  );
  reactHotLoader.register(
    _default,
    'default',
